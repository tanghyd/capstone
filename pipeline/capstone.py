...
def load_spacy_model(base_model="en_core_web_lg", output_type='doc', entity_ruler=True, 
        entities_path=entities_path, lemmatizer=True, stopword_removal=True, verbose=True):
